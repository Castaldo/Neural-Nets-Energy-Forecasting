...
VA = pd.read_csv("Project/Data/Processed/VA.csv")
VA = VA.fillna(0)
VA = VA.loc[VA['Energy'] != 0]

Features = ['Temperature', 'Hour', 'Season', 'Month', 'Wind speed', 'Day', 'Weekend', 'Relative Humidity', 'Snow depth', 'Wind speed', 'Wind direction',
            'Snowfall']
