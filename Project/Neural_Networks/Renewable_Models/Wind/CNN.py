...
def plot_model_mape(history, string):
    ...
    plt.savefig('Project/Dashboards/assets/images/Wind/' + string + '_MAPE_CNN.png', bbox_inches='tight')
...
def plot_model_loss(history, string):
    ...
    plt.savefig('Project/Dashboards/assets/images/Wind/' + string + '_Loss_CNN.png', bbox_inches='tight')
...
def Convultional(data, string):
    ...
    with open("Project/Saved_Models/Wind/" + string + "/CNN/" + string + "_CNN.json", "w") as json_file:
        json_file.write(CNN_JSON)
        
    CNN.save_weights('Project/Saved_Models/Wind/' + string + '/CNN/' + string + '_CNN.h5')
...
AU_Wind_CNN = Convultional(AU_Wind, 'AU_Wind')
tf.keras.backend.clear_session()

FR_Wind_CNN = Convultional(FR_Wind, 'FR_Wind')
tf.keras.backend.clear_session()

DK_Wind_CNN = Convultional(DK_Wind, 'DK_Wind')
tf.keras.backend.clear_session()
