...
def plot_model_mape(history, string):
    ...
    plt.savefig('Project/Dashboards/assets/images/Wind/' + string + '_MAPE_LSTM.png', bbox_inches='tight')
...
def plot_model_loss(history, string):
    ...
    plt.savefig('Project/Dashboards/assets/images/Wind/' + string + '_Loss_LSTM.png', bbox_inches='tight')
...
def LSTM_Netwrok(data, string):
    ...
    with open("Project/Saved_Models/Wind/" + string + "/LSTM/" + string + "_LSTM.json", "w") as json_file:
        json_file.write(LSTM_JSON)
        
    LSTM_Model.save_weights('Project/Saved_Models/Wind/' + string + '/LSTM/' + string + '_LSTM.h5')
...
AU_Wind_LSTM = LSTM_Netwrok(AU_Wind, 'AU_Wind')
tf.keras.backend.clear_session()

DK_Wind_LSTM = LSTM_Netwrok(DK_Wind, 'DK_Wind')
tf.keras.backend.clear_session()

FR_Wind_LSTM = LSTM_Netwrok(FR_Wind, 'FR_Wind')
tf.keras.backend.clear_session()