...
def plot_model_mape(history, string):
    ...
    plt.savefig('Project/Dashboards/assets/images/Solar/' + string + '_MAPE_CNN_LSTM.png', bbox_inches='tight')
...
def plot_model_loss(history, string):
    ...
    plt.savefig('Project/Dashboards/assets/images/Solar/' + string + '_Loss_CNN_LSTM.png', bbox_inches='tight')
...
def CNN_LSTM(data, string):
    ...
    with open("Project/Saved_Models/Solar/AU_Solar/" + string + "/CNN_LSTM/" + string + "_CNN_LSTM.json", "w") as json_file:
        json_file.write(CNN_LSTM_JSON)
        
    CNN_LSTM.save_weights('Project/Saved_Models/Solar/AU_Solar/' + string + '/CNN_LSTM/' + string + '_CNN_LSTM.json.h5')
...
AU_Solar_CNN_LSTM = CNN_LSTM(AU_Solar, 'AU_Solar')
tf.keras.backend.clear_session()

FR_Solar_CNN_LSTM = CNN_LSTM(FR_Solar, 'FR_Solar')
tf.keras.backend.clear_session()

DK_Solar_CNN_LSTM = CNN_LSTM(DK_Solar, 'DK_Solar')
tf.keras.backend.clear_session()
