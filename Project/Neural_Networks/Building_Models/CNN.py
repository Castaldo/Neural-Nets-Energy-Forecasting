...
def plot_model_mape(history, string):
    ...
    plt.savefig('Project/Dashboards/Assets/images/Buildings/' + string + '_MAPE_CNN.png', bbox_inches='tight')
...
def plot_model_loss(history, string):
    ...
    plt.savefig('Project/Dashboards/Assets/images/Buildings/' + string + '_Loss_CNN.png', bbox_inches='tight')
...
def Convultional(data, string):
    ...
    with open("Project/Saved_Models/Buildings/" + string + "/CNN/" + string + "_CNN_LSTM.json", "w") as json_file:
        json_file.write(CNN_JSON)
        
    CNN.save_weights('Project/Saved_Models/Buildings/' + string + '/CNN_LSTM/' + string + '_CNN_LSTM.h5')
...
Lot835_CNN = Convultional(Lot835, 'Lot_835')
tf.keras.backend.clear_session()

Lot1265_CNN = Convultional(Lot1265, 'Lot_1265')
tf.keras.backend.clear_session()

Lot1297_CNN = Convultional(Lot1297, 'Lot_1297')
tf.keras.backend.clear_session()
