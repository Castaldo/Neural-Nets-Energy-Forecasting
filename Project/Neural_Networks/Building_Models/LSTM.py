...
def plot_model_mape(history, string):
    ...
    plt.savefig('Project/Dashboards/Assets/images/Buildings/' + string + '_MAPE_LSTM.png', bbox_inches='tight')
...
def plot_model_loss(history, string):
    ...
    plt.savefig('Project/Dashboards/Assets/images/Buildings/' + string + '_Loss_LSTM.png', bbox_inches='tight')
...
def LSTM_Network(data, string):
    ...
    with open("Project/Saved_Models/Buildings/" + string + "/LSTM/" + string + "_LSTM.json", "w") as json_file:
        json_file.write(LSTM_JSON)
        
    LSTM_Model.save_weights('Project/Saved_Models/Buildings/' + string + '/LSTM/' + string + '_LSTM.h5')
...
Lot835_LSTM = LSTM_Network(Lot835, 'Lot_835')
tf.keras.backend.clear_session()

Lot1265_LSTM = LSTM_Network(Lot1265, 'Lot_1265')
tf.keras.backend.clear_session()

Lot1297_LSTM = LSTM_Network(Lot1297, 'Lot_1297')
tf.keras.backend.clear_session()