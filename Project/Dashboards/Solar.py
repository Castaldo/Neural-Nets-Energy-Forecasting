...
def select_model(country, passed_model):
    ...
    model_json_file = open ('Project/Saved_Models/Solar/' + country + '/' + passed_model + '/' + country + '_' + passed_model + '.json', 'r')
    model = model_json_file.read()
    model_json_file.close()
    model = model_from_json(model)
    model.load_weights('Project/Saved_Models/Solar/' + country + '/' + passed_model + '/' + country + '_' + passed_model + '.h5')
    model.save('Project/Saved_Models/Solar/' + country + '/' + passed_model + '/' + country + '_' + passed_model + '.hdf5')
    model = load_model('Project/Saved_Models/Solar/' + country + '/' + passed_model + '/' + country + '_' + passed_model + '.hdf5', compile = False)   
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.H5(
                                    "Solar Generation", style={"margin-top": "0px"}
                                ),
                            ]
                        )
                    ],
...
def inital_graph(country, model_value):
    ...
    country_str = {1: 'AU_Solar', 2: 'FR_Solar', 3: 'DK_Solar'}
    country_code = {1: AU_Solar, 2: FR_Solar, 3: DK_Solar}
...
def graph_mape (city, model):
    ...
    MAPE = "assets/images/Solar/" + city_code[city] + "_solar_MAPE_" + model_code[model] + ".png"
...
def graph_loss (city, model):
    ...
    Loss = "assets/images/Solar/" + city_code[city] + "_solar_Loss_" + model_code[model] + ".png"
